...
const workbench = {
  ...
  topology: Effect.die(new Error("unused")),
  reviewRelationship: () => Effect.die(new Error("unused")),
  reviewInboxCommand: () => Effect.die(new Error("unused")),
  projectionHealth: Effect.die(new Error("unused")),
  reviewProjection: () => Effect.die(new Error("unused")),
  applyProjection: () => Effect.die(new Error("unused")),
  rollbackProjection: () => Effect.die(new Error("unused")),
  audit: Effect.die(new Error("unused")),
