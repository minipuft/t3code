...
import { WorkbenchCatalogContextPanel } from "./chat/WorkbenchCatalogContextPanel";
import { WorkbenchPlanContextPanel } from "./chat/WorkbenchPlanContextPanel";
...
export default function ChatView(props: ChatViewProps) {
  ...
  const rightPanelContent = activeThreadRef ? (
    renderedRightPanelSurface?.kind === "preview" ? (
      ...
      />
    ) : renderedRightPanelSurface?.kind === "actions" ? (
      <WorkbenchCatalogContextPanel
        environmentId={activeThreadRef.environmentId}
        module="prompts"
        onInsertInvocation={insertWorkbenchInvocation}
      />
    ) : renderedRightPanelSurface?.kind === "skills" ? (
      <WorkbenchCatalogContextPanel
        environmentId={activeThreadRef.environmentId}
        module="skills"
        onInsertInvocation={insertWorkbenchInvocation}
