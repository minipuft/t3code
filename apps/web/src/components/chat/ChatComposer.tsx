    ...
    const observeControls = () => {
      ...
      controls
        .querySelectorAll<HTMLElement>(
          "[data-resting-block], [data-resting-fixed-control], [data-composer-control-label], [data-chat-provider-model-picker-label]",
        )
  ...
  const composerControls = showProviderUnavailable ? (
    ...
    <>
      ...
      {workflowPicker.actionsVisible ? (
        <div data-resting-fixed-control="actions" className="flex shrink-0 items-center">
          <ComposerWorkflowActionsControl
            compact={composerControlsInStrip || isComposerFooterCompact}
            size={composerControlsInStrip ? "xs" : "sm"}
