...
A provider-neutral prompt or skill exposed by an environment’s workflow catalog and inserted
through the composer. Definitions stay canonical at their source; pins and named presets belong
to an environment, while recent action identities stay local to a client.
