...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server persists workflow pins and presets through semantic mutations.
      Absent on older servers, so clients retain catalog browsing but hide mutations. */
  workflowPreferences: Schema.optionalKey(Schema.Boolean),
